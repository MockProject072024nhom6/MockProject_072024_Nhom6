    ...
    <div className='flex bg-white rounded-lg shadow-lg p-14 mb-4 mx-32'>
      ...
      <div className='flex flex-col justify-between ml-4 flex-grow'>
        ...
        <div className='flex justify-between items-center mt-4'>
          <div>
            <span className='bg-green-100 text-green-800 px-2 py-1 rounded-lg'>{priceRange}</span>
            <span className='bg-yellow-100 text-yellow-800 px-2 py-1 ml-2 rounded-lg'>{groupSize}</span>
          </div>
          <button className='bg-blue-500 text-white px-4 py-2 rounded-lg'>Booking now</button>
        </div>
      </div>
    </div>
  )
