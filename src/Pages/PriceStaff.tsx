...
import {
  PriceStaffContainer,
  PriceStaffHeader,
  PriceStaffSearchContainer,
  PriceStaffSearchInputContainer,
  PriceStaffSearchInput,
  PriceStaffSearchIcon,
  PriceStaffFilterContainer,
  PriceStaffFilterIcon,
  PriceStaffFilterText,
  PriceStaffTableContainer,
  PriceStaffTable,
  PriceStaffTableHeader,
  PriceStaffTableHeaderCell,
  PriceStaffTableBodyCell,
  PriceStaffCheckbox,
  PriceStaffActionButtons,
  PriceStaffActionButton,
  PriceStaffPaginationContainer,
  PriceStaffPaginationButton,
  PriceStaffPaginationShowing,
  PriceStaffPaginationLink
    ...
    <div className={PriceStaffContainer}>
      ...
      <div className={PriceStaffSearchContainer}>
        <div className={PriceStaffSearchInputContainer}>
          ...
          <input type='text' placeholder='Search...' className={PriceStaffSearchInput} />
        </div>
        ...
        {data && data.length > 0 ? (
          <table className={PriceStaffTable}>
            <thead className={PriceStaffTableHeader}>
              <tr>
                <th className={PriceStaffTableHeaderCell}>
                  <input type='checkbox' className={PriceStaffCheckbox} />
                </th>
                ...
                <th className={PriceStaffTableHeaderCell} style={{ width: "8rem" }}>
                  Action
                </th>
              </tr>
            </thead>
                ...
                <tr key={index}>
                  ...
                  <td className={PriceStaffTableBodyCell}>
                    <div className={PriceStaffActionButtons}>
                      <a href='#add' className={PriceStaffActionButton}>
                        <Plus />
                      </a>
                      <a href='#edit' className={PriceStaffActionButton}>
                        <Edit />
                      </a>
                      <a href='#delete' className={PriceStaffActionButton}>
                        <Trash />
                      </a>
                    </div>
                  </td>
      ...
      <div className={PriceStaffPaginationContainer}>
        ...
        <div className='flex space-x-2'>
          <a href='#prev' className={PriceStaffPaginationButton}>
            Prev
          </a>
          <a href='#1' className={PriceStaffPaginationLink}>
            1
          </a>
          <a href='#2' className={PriceStaffPaginationLink}>
            2
          </a>
          <a href='#more' className={PriceStaffPaginationLink}>
            ...
          </a>
          <a href='#next' className={PriceStaffPaginationButton}>
            Next
          </a>
        </div>
      </div>
