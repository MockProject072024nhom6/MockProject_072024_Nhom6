...
const AboutXPressGuardsPage: React.FC = () => {
  return (
    <main className='bg-white m-0 p-0'>
      <HeaderInPageHome title={"About XPressGuards"} subtitle={"About XPressGuards"} page={"Home"} />
      <MissionStatementAndServices />
      <ServiceDetails />
      <Achievements clientsProtected={3457} yearsOfExperience={34} officeLocations={614} statesServed={50} />
      <Security />
      <div className='px-40'>
