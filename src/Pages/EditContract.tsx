  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-semibold text-left ml-4">Edit Contract</h1>
      </div>
      ...
      {/* Nút Save và Send Approval */}
      <div className="flex justify-end space-x-4">
        <button className="px-4 py-2 border border-gray-300 text-white bg-blue-600 rounded-md hover:bg-blue-700">Save Change</button>
        <button className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Send Approval</button>
      </div>
    </div>
  );
}
