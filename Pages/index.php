...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO guards (name, date_of_birth, gender, phone_number, address, status, guard_id) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssss", $name, $date_of_birth, $gender, $phone_number, $address, $status, $guard_id);
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-board">
                        <form method="get" action="">
                            ...
                            <div class="form-group">
                                <label for="guardIdFilter">GuardID</label>
                                <input type="text" class="form-control" id="guardIdFilter" name="guard_id">
                            </div>
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><a href="sgm_edit.php?id=<?php echo $row['guard_id']; ?>" class="btn btn-sm btn-outline-primary">Edit</a></td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="9">No guards found.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
    ...
    <div class="modal-content">
        ...
        <form action="index.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="guard_id" name="guard_id" class="form-control" required>
            </div>
            <button type="submit" class="btn btn-primary">Save</button>
            <button type="button" class="btn btn-secondary close"><a href="index.php">Cancel</a></button>
        </form>
    </div>
</div>
